...
> 이 글은 'KISTI DATA INSIGHT 제15호 : 미래기술 위크시그널'를 참고하여 특허 데이터에 적용해 본 분석 내용입니다.

> 자세한 참고는 ([KISTI DATA INSIGHT 제15호 : 미래기술 위크시그널](https://www.kisti.re.kr/post/data-insight?t=1668036309836))를 보시는 것을 추천드립니다.
