# <img src="/img/kipi_logo.png" width="5%" height="3%" title="px(픽셀) 크기 설정" alt="kipi" align="left">특허 DATA를 활용한 미래 기술 위크시그널 분석1 - 키프레이즈 기반으로 </img>
